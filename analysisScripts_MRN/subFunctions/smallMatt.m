function [numSubjs, allTrialDraws, uniqueVar, allNames] = smallMatt(trialData,totTime,totDetTime,infoChoiceTime,firstInfoTime,sideChoiceTime,feedbackTime,maxDrawTime,allPCJitter,allFIJitter,allETJitter,infRespTime, P)


 % P is the probability of selecting info the first choice (or being FORCED
 % to get info on the first choice). 
